...
const Motto = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-teal-50 via-white to-cyan-50">
      ...
      <div className="relative bg-gradient-to-r from-teal-600 via-cyan-600 to-blue-600 text-white py-24 overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="text-center">
            ...
            <p className="text-2xl md:text-3xl font-semibold mb-4 text-teal-100">
              Guiding Principles That Drive Us Forward
            </p>
            <div className="max-w-4xl mx-auto">
              <p className="text-xl md:text-2xl leading-relaxed text-teal-50 mb-6">
          ...
          {mottos.map((motto, index) => (
            ...
            >
              ...
              <div className="p-6">
                ...
                <p className="text-teal-600 font-semibold italic mb-3 text-sm">
                ...
                <div className="flex items-start space-x-6">
                  ...
                  <div className="flex-1">
                    <div className="flex items-center mb-3">
                      <span className="text-4xl mr-3">{principle.icon}</span>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {inspirations.map((inspiration, index) => (
            <div
              key={index}
              className="bg-gradient-to-br from-teal-50 to-cyan-50 rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 p-8 transform hover:-translate-y-1 border-l-4 border-teal-600"
            >
              <div className="text-5xl mb-4 text-center">{inspiration.icon}</div>
              <p className="text-gray-700 text-lg leading-relaxed italic mb-4 text-center">
      ...
      {/* Commitment Section */}
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="bg-gradient-to-r from-teal-600 via-cyan-600 to-blue-600 rounded-3xl shadow-2xl p-12 text-white text-center overflow-hidden relative">
          ...
          <div className="relative z-10">
            ...
            <p className="text-xl md:text-2xl leading-relaxed max-w-4xl mx-auto mb-8 text-teal-50">
